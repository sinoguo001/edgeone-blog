// ============================================================
// EdgeOne Makers 云函数唯一入口（catch-all：cloud-functions/[[default]].js）
// 负责：/api/* 接口、/media/* 图片代理（Blob 存储）、前台页面 SSR、
//       rss.xml / sitemap.xml / robots.txt
// 说明：后台与静态资源不再经这里处理 —— EdgeOne 的路由优先级是
...
import { resolveEnv } from './_lib/store/index.js';
...
import { connect } from './_lib/store/net.js';
